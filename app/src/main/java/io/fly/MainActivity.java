...
public class MainActivity extends Activity implements LocationListener, GpsStatus.Listener {
    ...
    public void onFabClick(View v){
        if (!data.isRunning()) {
            fab.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_action_pause));
            ...
            fab.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_action_play));
